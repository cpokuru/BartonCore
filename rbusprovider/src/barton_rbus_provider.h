...
#define BARTON_RBUS_METHOD_LIST_DEVICES     "Device.IoT.Device.List()"
...
#define BARTON_RBUS_METHOD_QUERY_RESOURCES  "Device.IoT.Resource.Query()"
#define BARTON_RBUS_METHOD_READ_METADATA    "Device.IoT.Metadata.Read()"
#define BARTON_RBUS_METHOD_WRITE_METADATA   "Device.IoT.Metadata.Write()"
